...
const systemInfoViews = async () => {
	...
	const printDataStandard = () => {
		...
		return {
			...
			tableCPUStd: tableCPUStnd.toString(),
			tableSystemStd: tableSystemStnd.toString(),
			tableMemoryStd: tableMemoryStnd.toString(),
			tableOSStd: tableOSStnd.toString(),
			tableDiskStd: tableDiskStnd.toString(),
			tableNetworkStd: tableNetworkStnd.toString()
		};
	};
	...
	const printDataExtended = () => {
		...
		return {
			tableExt: table.toString(),
			tableCpuExt: tableCPUExt.toString(),
			tableSystemExt: tableSystemExt.toString(),
			tableBiosExt: tableBiosExt.toString(),
			tableMotherboardExt: tableBaseboardExt.toString(),
			tableMemoryExt: tableMemoryExt.toString(),
			tableMemoryLayoutExt: tableMemoryLayoutExt.toString(),
			tableOSExt: tableOSExt.toString(),
			tableVersionsExt: tableVersionsExt.toString(),
			tableDiskExt: tableDiskExt.toString(),
			tableFSExt: tableFsSizeExt.toString(),
			tableNetworkExt: tableNetworkExt.toString()
		};
	};
