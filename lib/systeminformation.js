...
const printSysInfo = async () => {
	...
	const extendedSystemView = {
		cpu: 'manufacturer, brand, speed, cors, physicalCores, processors, socket, vendor, family, model, voltage, virtualization, cache',
		...
		memLayout:
			'size, bank, type, ecc, clockSpeed, formFactor, voltageConfigured',
		osInfo:
		...
		diskLayout:
			'device, type, name, size, vendor, smartData, smartStatus, interfaceType, totalSectors, totalCylinders, totalHeads',
